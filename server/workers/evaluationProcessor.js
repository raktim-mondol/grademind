...
evaluationQueue.process(async (job) => {
  ...
  try {
    ...
    // Augment assignmentData with gradingSchema from job payload
    // This ensures the pre-extracted schema from assignment creation is used for consistent grading
    if (gradingSchema) {
