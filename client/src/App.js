...
import GradeMindApp from './grademind/GradeMindApp';
...
function App() {
  ...
  return (
    <Router>
      <Routes>
        {/* GradeMind - New Modern UI (full-screen, no header) */}
        <Route path="/grademind/*" element={<GradeMindApp />} />

        {/* Legacy EduGrade routes with header */}
        <Route path="/*" element={
          <>
            <Header />
            <main className="py-3">
